...
def runPhymlMulti(parameters):
    ...
    if False:#phymlOpt != "":
        ...
        subprocess.run("phyml_multi %s 0 i 1 0 HKY e e 4 e BIONJ y y y 2"%(outPhy),shell=True,stdout=subprocess.PIPE)
    ...
    outpart = os.path.join(geneDir,queryName + "_outpart.txt")
    fout=open(outpart,"w")
